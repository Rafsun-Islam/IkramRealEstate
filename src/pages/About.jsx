          ...
          <div className="about-intro__content">
            ...
            <div className="about-intro__highlights">
              ...
              <article>
                ...
                <div>
                  <h3>Client First</h3>
                  <p>We guide every client with clarity and professionalism.</p>
                </div>
              </article>
            </div>
          </div>
      ...
      <section className="section about-trust">
        <div className="container about-trust__grid">
          <div className="about-trust__content">
            ...
            <p>
              Buying or investing in property is a big decision. We help clients
              with clear information, professional support, and reliable project
              guidance from the first conversation to final handover.
            </p>
          </div>
